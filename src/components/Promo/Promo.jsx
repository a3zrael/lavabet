  ...
  return (
    <section className={styles.section_screen}>
      <div className={styles.section_inner}>
        ...
        <div className={(styles.section_list_promo, styles.section_list)}>
          <div className={(styles.section_firts, styles.section_list)}>
            <img src={icon1} alt="" />
            <p className={styles.section_firts}>
              Make a cool product for your traffic with a high CR
            </p>
          </div>
          <div className={(styles.section_second, styles.section_list)}>
            <img src={icon2} alt="" />
            <p className={styles.section_second_text}>
              Create a stable and comfortable environment
            </p>
          </div>
          <div className={(styles.section_last, styles.section_list)}>
            <img src={icon3} alt="" />
